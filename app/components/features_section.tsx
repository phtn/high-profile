const FEATURES = [
  {
    title: "Multi-chain",
    description:
      "Accept Bitcoin, Ethereum, and stablecoins through a single integration.",
    icon: (
      <path
        strokeLinecap="round"
  ...
  },
  {
    ...
    description:
      "Settle in fiat or hold crypto. Real-time rates and transparent fees.",
    icon: (
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  },
  {
    title: "Developer API",
    description:
      "REST and webhooks. Clear docs and sandbox. Go live in hours.",
    icon: (
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
    ...
    >
      <div className="mx-auto max-w-6xl">
        ...
        <p className="mt-3 max-w-xl text-neutral-500 dark:text-neutral-400">
          One API. Multiple chains. Instant confirmation and flexible
          settlement.
        </p>
        <ul
        ...
        >
          {FEATURES.map((item) => (
            <li
              key={item.title}
              className="group bg-white p-8 dark:bg-neutral-950"
            >
              ...
              <h3 className="mt-5 text-lg font-medium text-neutral-900 dark:text-white">
                {item.title}
              </h3>
