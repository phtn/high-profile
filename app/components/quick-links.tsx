...
export function QuickLinksSection() {
  return (
    <section
      id='quick-links'
      className='border-t border-neutral-200 dark:bg-neutral-500/10 px-4 py-18 dark:border-neutral-900 bg-neutral-950/10 sm:px-6 sm:py-24 lg:px-8'>
      <div className='mx-auto max-w-6xl'>
        <ol className='grid gap-x-2 sm:grid-cols-3' role='list' aria-label='Steps to integrate'>
          {STEPS.map((item) => (
