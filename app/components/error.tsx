...
import { useCallback, useMemo, useState, useTransition, ViewTransition } from 'react'
          ...
          <div className='p-6 sm:p-8'>
            ...
            <div className='flex items-start gap-4 mb-6'>
              ...
              <div className='min-w-0 flex-1'>
                <div className='text-lg md:text-2xl font-cv font-semibold text-neutral-900/50 dark:text-zinc-100/50 justify-start w-fit'>
            ...
            <div
              ...
              <p className='text-sm text-neutral-600 dark:text-zinc-300'>{errorInsight.suggestion}</p>
            </div>
