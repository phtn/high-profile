import type { CryptoApiResponse, CryptoQuote } from '@/app/api/cmc/types'
import { useCallback, useEffect, useState, useTransition } from 'react'

interface UseCMCOptions {
...
export const useCMC = (options: UseCMCOptions = {}): UseCMCReturn => {
